...
**Status:** **Inkwood 2 is the game** (director's ruling 2026-09-06): everyone's first run is the redrawn scenes, rewritten story, light layer, typing feel, and tween. The first edition ("Classic", April 2026) stays playable behind `?classic` and a toggle on the Wander screen after the first completion. v1.5 archived (tag `v1.5`). Music/ink/seasons still gated off awaiting verdicts (Session History #18).
